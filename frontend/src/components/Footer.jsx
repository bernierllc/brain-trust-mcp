    ...
    <footer className="footer-container">
      <div className="footer-content">
        ...
        <div className="footer-bottom">
          ...
          <p className="footer-copyright">
            Built with <a href="https://cursor.com/" target="_blank">Cursor</a>, <a href="https://bolt.new/?rid=bmy46m" target="_blank">Bolt.new</a>, <a href="https://gofastmcp.com/getting-started/welcome" target="_blank">FastMCP</a>, OpenAI, and React
          </p>
        </div>
      </div>
    </footer>
